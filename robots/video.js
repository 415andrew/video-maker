...
async function robot() {
	...
	await conventAllImages(content)
	...
	async function conventAllImages(content) {
	...
	async function createYouTubeThumbnail() {
		return new Promise((resolve, reject) => {
			gm()
				...
				.write('./content/createYouTubeThumbnail.jpg', (error) => {
					if (error) {
						return reject(error)
					}
	...
	async function renderVideoWithAfterEffects() {
		return new Promise((resolve, reject) => {
			...
			const templeteFilePath = `${rootPath}/templates/1/template.aep`
